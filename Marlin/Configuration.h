...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  //#define PID_PARAMS_PER_HOTEND // Use separate PID parameters for each extruder (useful for mismatched extruders)
    ...
    #define DEFAULT_Kp_LIST {  13.52,  13.52 }
    #define DEFAULT_Ki_LIST {   0.91,   0.91 }
    #define DEFAULT_Kd_LIST { 50.32, 50.32 }
  #else
 ...
 */
#define X_MIN_ENDSTOP_HIT_STATE LOW  //X_MIN_ENDSTOP_INVERTING true 
#define X_MAX_ENDSTOP_HIT_STATE HIGH
#define Y_MIN_ENDSTOP_HIT_STATE LOW //Y_MIN_ENDSTOP_INVERTING true
...
#define DETECT_BROKEN_ENDSTOP //ADDED this NEW
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -45, -15, -1.32 }
...
//#define EVENT_GCODE_AFTER_HOMING "G34"
